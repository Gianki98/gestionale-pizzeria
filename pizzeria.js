...
function showHalfFamilyModal(editIndex = null) {
  ...
  // Definisci le funzioni globalmente prima di creare il modal
  window.handleFirstHalfChange = function () {
  ...
  window.handleSecondHalfChange = function () {
    ...
    <div class="modal-content" style="max-width: 700px;">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <select class="form-control" id="firstHalf" onchange="handleFirstHalfChange()">
        ...
        <div class="form-group">
          ...
          <select class="form-control" id="secondHalf" onchange="handleSecondHalfChange()">
            <option value="">-- Seleziona --</option>
          </select>
        </div>
  ...
  `;
  // IMPORTANTE: Ottieni i riferimenti DOPO aver settato innerHTML
  const firstHalfSelect = document.getElementById("firstHalf");
  const secondHalfSelect = document.getElementById("secondHalf");
...
function showEditOrderItemModal(index) {
  ...
  `;
    ...
    editFullBtn.id = "editHalfFamilyBtn"; // Aggiungi un ID univoco
